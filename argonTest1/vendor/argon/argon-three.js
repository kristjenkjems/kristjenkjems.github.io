...
})(this, function(__WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_58__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ARGON = module.exports = __webpack_require__(17);
	var THREE = __webpack_require__(15);
	THREE.Bootstrap = __webpack_require__(58);
	...
	if (!THREE.CSS3DRenderer) __webpack_require__(59);

	ARGON.THREE = {
	  MultiRenderer: __webpack_require__(60),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ARGON = __webpack_require__(17);
	var THREE = __webpack_require__(15);
	THREE.Bootstrap = __webpack_require__(58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bindObjectToContext = function (context, component, threeObject) {
	  ...
	  proxy.handler.on("stateUpdate", function (event) {
	    ...
	    var hasTransform = !!finalTransform;
	    if (threeObject._hasArgonTransform !== hasTransform) {
	      if (hasTransform) {
	    ...
	    threeObject._hasArgonTransform = hasTransform;
	  });
	...
	module.exports = function bind(context, argonComponent, threeObject) {
	  if (context instanceof ARGON.Component) {
	    ...
	    console.warn("ARGON.THREE.bind broke with newer versions of three.js." + " Now you must also provide a context. Ex:" + " ARGON.THREE.bind(ARGON.immersiveContext, component, threeObject)");
	  }
